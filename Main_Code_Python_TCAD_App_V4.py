...
root = tk.Tk()
root.title("Welcome to TCAD Automatic Simulation Tool")
...
path_dir = r"C:\Users\lop94\PycharmProjects\pythonProject1"
...
def Exportdata():
    ...
    workbook.close()
def Importdata():
    original = r'C:\Users\lop94\PycharmProjects\pythonProject1\Input.IN'
